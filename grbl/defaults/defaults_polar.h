/*
  defaults_polar.h - defaults settings configuration file
  Part of Grbl
...
#define defaults_h
  ...
  #define DEFAULT_DISTANCE 740.0 // mm - horizontal distance between Polargraph motor gear centers
  #define DEFAULT_HOMING_VERTICAL_DISTANCE 60 // mm - vertical distance of manually homed gondola in the middle
